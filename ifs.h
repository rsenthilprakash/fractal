...
/* a kind of spiral */
struct affineTrans rules_spiral[] = { {0.8188251, 0.8711631, -0.1568270, 0.9451363, 0.5044009, 0.2600615, 0.5000000, 0},
                                      {0.3899677, -0.6386825, -0.2169008, -0.1310590, -0.4387605, 0.6664247, 0.5000000, 0} };
struct dimenstion dim_spiral = {10, 10, 1, 2, 2, 4};
...
struct shapeData shape_database[] = { {"spiral", rules_spiral, 2, &dim_spiral},
